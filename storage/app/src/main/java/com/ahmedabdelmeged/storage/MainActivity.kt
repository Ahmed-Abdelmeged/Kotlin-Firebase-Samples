...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    public override fun onStart() {
        ...
        manager.registerReceiver(mBroadcastReceiver!!, MyDownloadService.intentFilter())
    ...
    private fun updateUI(user: FirebaseUser?) {
        ...
        if (user != null) {
            ...
            layout_storage.visibility = View.VISIBLE
        } else {
            layout_signin.visibility = View.VISIBLE
            layout_storage.visibility = View.GONE
        }

        // Download URL and Download button
        if (mDownloadUrl != null) {
            picture_download_uri.text = mDownloadUrl!!.toString()
            layout_download.visibility = View.VISIBLE
        } else {
            picture_download_uri.text = null
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.button_camera -> launchCamera()
            R.id.button_sign_in -> signInAnonymously()
            R.id.button_download -> beginDownload()
        }
    }
